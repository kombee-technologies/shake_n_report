class ApiEndPoints {
  ...
  static const String getAccessibleResourcesJira = 'https://api.atlassian.com/oauth/token/accessible-resources';
  ...
  static String createIssueJira(String cloudId) => 'https://api.atlassian.com/ex/jira/$cloudId/rest/api/3/issue';
